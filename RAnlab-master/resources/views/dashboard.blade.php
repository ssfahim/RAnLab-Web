<x-app-layout>
    ...
    {{-- Population Change and age pie chart --}}
    <div class="dashboard_row print-container"  id="demography" style=" font-family: 'Avenir';">
        ...
        {{-- Age Characteristics --}}
        <div class="dashboard_row_half dashboard_row_item">
            <h3 style="font: 800 30px monospace; font-family: 'Avenir';">Age Characteristics</h3><br>
            <div style="display: flex;
                ...
                margin-bottom: 5px;">
                {{-- <table style="margin-left: 15px; font-family:'Avenir'; ">
                    <tr>
                        <td>
                            <div class="counter-container" style="font: 800 40px monospace; padding: 2rem; margin-bottom: 1rem; text-align: center; width: 140px; display: flex; align-items: center;">
    ...
    <div class="dashboard_row print-container" style="margin-top: 15px;" id="populationPyramid">
        <div class="dashboard_row_full dashboard_row_item">
            <h3 style="font: 800 30px monospace; font-family: 'Avenir';">Population Structure</h3><br>
    ...
    {{-- Housing numbers and owner/renter pie chart --}}
    <div class="dashboard_row print-container"  id="housing">
        {{-- House Dwellings --}}
        <div class="dashboard_row_half dashboard_row_item">
            <h3 style="font: 800 30px monospace;">Households and Dwellings</h3><br>
            <div style="display: flex;
            /* width: 80%; */
            /* height: auto; */
            flex-direction: column;
    ...
    {{-- Labour Supply education bar chart and education level --}}
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
                    const chart = new ApexCharts(document.querySelector("#yourChartId"), {
