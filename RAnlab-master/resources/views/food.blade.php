<x-app-layout>
    ...
    #selectedTables {
        width: 100%; /* Add this line to make it take up the full width */
    ...
    #tableWork div#content div.scrollable th.boxed {
        background-color: #333; 
        color: rgb(0, 0, 0); 
        padding: 20px;
        text-align: center;
    ...
    .menuBox:active {
        background-color: #e6e6e6; /* Change background color on click */
    ...
    <div id = 'tableWork'>
        ...
        <button onclick="generateTable()" style="boarder: 2px solid black">Populate table</button>
        <button onclick="resetPage()">Refresh</button>
    ...
    function createPlot(selectedRows, csvData, dates,a ) {
        ...
        // Layout for the plot
        var layout = {
            title: '<span style="font-weight: bold; font-size: 1.5em;">Average Retail Prices in Newfoundland and Labrador (2017-2023)</span><br>' +
            '<span style="font-size: 1em;">Note about what the colors mean here. Darker means this and lighter color implies this. <br>' +
            'Note about Kg and dollar amount. Should be clear how someone would summarize in a sentence what they’re looking at.</span><br>',
             xaxis: {
                title: 'Time Period',
    ...
    <!-- var price = [0.46, 0.45, 0.68, 0.69, 0.68, 0.75, 0.77, 0.2, 0.18, 0.18, 0.18, 0.22, 0.22, 0.26, 0.28, 0.26, 0.27, 0.28, 0.37, 0.53, 0.2, 0.34, 0.36, 0.36, 0.36, 0.38, 0.42, 0.43, 1.22, 1.13, 1.04, 1.29, 1.25, 1.55, 1.54];
